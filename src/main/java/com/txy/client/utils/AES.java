...
public class AES {
    ...
    //加密
    public static void encryptFile(String fileName,String encryptedFileName,SecretKey key){
    ...
    //解密
    public static void decryptedFile(InputStream fis, OutputStream fos, SecretKey key){
