...
!function (a, b) {
    ...
    function h() {
        if (!window.PointerEvent) {
            ...
            } else u.registerSource("mouse", P), void 0 !== window.ontouchstart && u.registerSource("touch", _);
            u.register(document)
        }
    }
    ...
    var k = ["bubbles", "cancelable", "view", "detail", "screenX", "screenY", "clientX", "clientY", "ctrlKey", "altKey", "shiftKey", "metaKey", "button", "relatedTarget", "pageX", "pageY"], l = [!1, !1, null, null, 0, 0, 0, 0, !1, !1, !1, !1, 0, null, 0, 0], m = a, n = window.Map && window.Map.prototype.forEach, o = n ? Map : b;
    b.prototype = {
        set: function (a, b) {
    ...
    var p = o, q = ["bubbles", "cancelable", "view", "detail", "screenX", "screenY", "clientX", "clientY", "ctrlKey", "altKey", "shiftKey", "metaKey", "button", "relatedTarget", "buttons", "pointerId", "width", "height", "pressure", "tiltX", "tiltY", "pointerType", "hwTimestamp", "isPrimary", "type", "target", "currentTarget", "which", "pageX", "pageY", "timeStamp"], r = [!1, !1, null, null, 0, 0, 0, 0, !1, !1, !1, !1, 0, null, 0, 0, 0, 0, 0, 0, 0, "", 0, !1, "", null, null, 0, 0, 0, 0], s = "undefined" != typeof SVGElementInstance, t = {
        ...
        cloneEvent: function (a) {
            for (var b, c = Object.create(null), d = 0; d < q.length; d++)b = q[d], c[b] = a[b] || r[d], !s || "target" !== b && "relatedTarget" !== b || c[b] instanceof SVGElementInstance && (c[b] = c[b].correspondingUseElement);
    ...
    }, w = Array.prototype.forEach.call.bind(Array.prototype.forEach), x = Array.prototype.map.call.bind(Array.prototype.map), y = Array.prototype.slice.call.bind(Array.prototype.slice), z = Array.prototype.filter.call.bind(Array.prototype.filter), A = window.MutationObserver || window.WebKitMutationObserver, B = "[touch-action]", C = {
        subtree: !0,
        childList: !0,
        attributes: !0,
        attributeOldValue: !0,
    ...
    var D = c, E = ["none", "auto", "pan-x", "pan-y", {
        rule: "pan-x pan-y",
        selectors: ["pan-x pan-y", "pan-y pan-x"]
    }], F = "", G = window.PointerEvent || window.MSPointerEvent, H = !window.ShadowDOMPolyfill && document.head.createShadowRoot, I = u.pointermap, J = 25, K = [1, 4, 2, 8, 16], L = !1;
    try {
    ...
    var N, O = {
        ...
        prepareEvent: function (a) {
            var b = u.cloneEvent(a), c = b.preventDefault;
        ...
        mousedown: function (a) {
            if (!this.isEventSimulatedFromTouch(a)) {
                var b = I.get(this.POINTER_ID), c = this.prepareEvent(a);
                L || (c.buttons = K[c.button], b && (c.buttons |= b.buttons), a.buttons = c.buttons), I.set(this.POINTER_ID, a), b ? u.move(c) : u.down(c)
            }
        },
        ...
        mouseup: function (a) {
            if (!this.isEventSimulatedFromTouch(a)) {
                ...
                I.set(this.POINTER_ID, a), 0 === c.buttons ? (this.cleanupMouse(), u.up(c)) : u.move(c)
            }
        },
    ...
    }, P = O, Q = u.captureInfo, R = v.findTarget.bind(v), S = v.allShadows.bind(v), T = u.pointermap, U = 2500, V = 200, W = "touch-action", X = !1, Y = {
        ...
        elementAdded: function (a) {
            ...
            c && (a._scrollType = c, u.listen(a, this.events), S(a).forEach(function (a) {
                a._scrollType = c, u.listen(a, this.events)
            }, this))
        },
        elementRemoved: function (a) {
            a._scrollType = void 0, u.unlisten(a, this.events), S(a).forEach(function (a) {
        ...
        touchToPointer: function (a) {
            var b = this.currentTouchEvent, c = u.cloneEvent(a), d = c.pointerId = a.identifier + 2;
        ...
        overDown: function (a) {
            T.set(a.pointerId, {target: a.target, out: a, outTarget: a.target}), u.over(a), u.enter(a), u.down(a)
        },
        ...
        moveOverOut: function (a) {
            ...
            if (c) {
                ...
                u.move(b), d && e !== b.target && (d.relatedTarget = b.target, b.relatedTarget = e, d.target = e, b.target ? (u.leaveOut(d), u.enterOver(b)) : (b.target = e, b.relatedTarget = null, this.cancelOut(b))), c.out = b, c.outTarget = b.target
            }
        },
        touchend: function (a) {
        ...
        upOut: function (a) {
            this.scrolling || (u.up(a), u.out(a), u.leave(a)), this.cleanUpPointer(a)
        },
    ...
    var Z, $, _ = Y, aa = u.pointermap, ba = window.MSPointerEvent && "number" == typeof window.MSPointerEvent.MSPOINTER_TYPE_MOUSE, ca = {
        ...
        prepareEvent: function (a) {
            var b = a;
            return ba && (b = u.cloneEvent(a), b.pointerType = this.POINTER_TYPES[a.pointerType]), b
        },
        cleanup: function (a) {
            aa["delete"](a)
        },
    ...
    var fa = {dispatcher: u, Installer: D, PointerEvent: m, PointerMap: p, targetFinding: v};
    return fa
});